...
import { IonHeader,IonToolbar,IonTitle,IonContent,IonList,IonItem,IonThumbnail,IonButton } from '@ionic/angular/standalone';
...
@Component({
  ...
  standalone:true,
  imports:[IonHeader,IonToolbar,IonTitle,IonContent,IonList,IonItem,IonThumbnail,CommonModule,IonButton,RouterLink]
})
